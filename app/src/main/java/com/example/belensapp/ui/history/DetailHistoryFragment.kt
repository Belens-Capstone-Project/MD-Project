...
class DetailHistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Mengambil data dari arguments yang dikirim
        ...
        if (predictResponse != null) {
            ...
            // Tampilkan grade image berdasarkan grade
            displayGradeImage(predictResponse.data?.gizi?.grade)

            // Tampilkan data gizi secara rinci
    ...
    private fun displayNutritionData(gizi: Gizi?) {
        ...
        // Move recommendation to the recomendation TextView
