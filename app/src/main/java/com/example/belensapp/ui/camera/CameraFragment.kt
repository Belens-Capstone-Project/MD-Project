...
class CameraFragment : Fragment() {
    ...
    private fun updateThemeAppearance() {
        when (resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK) {
            Configuration.UI_MODE_NIGHT_YES -> {
                ...
                // Change icon tint for Take Photo and Upload Photo buttons to white
            ...
            Configuration.UI_MODE_NIGHT_NO -> {
                // Optional: Reset to default colors in light mode if needed
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        // Update theme appearance when configuration changes (e.g., when switching between light and dark mode)
        updateThemeAppearance()
    }
    ...
    private fun processImage() {
        // Show progress bar before starting the process
        showLoading(true)
        ...
        when {
            capturedPhoto != null -> {
                ...
                file?.let {
                    ...
                    showLoading(false)
                    Toast.makeText(requireContext(), "Failed to process captured photo", Toast.LENGTH_SHORT).show()
                }
            }
    ...
    private fun uploadImage(file: File) {
        ...
        client.enqueue(object : Callback<PredictResponse> {
            ...
            override fun onFailure(call: Call<PredictResponse>, t: Throwable) {
                showLoading(false)  // Hide progress bar on failure
